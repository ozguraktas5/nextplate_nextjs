          ...
          <ul className="flex flex-wrap justify-center mt-32 gap-5">
            <li>
              <a href="" className="bg-gray-100 dark:bg-gray-950 text-xl px-10 py-3 rounded-xl">
                Application <span className="ml-3 px-3 bg-gray-50 dark:bg-gray-950">1</span>{" "}
              </a>
            </li>
            <li>
              <a href="" className="bg-gray-100 dark:bg-gray-950 text-xl px-10 py-3 rounded-xl">
                Data <span className="ml-3 px-3 bg-gray-50 dark:bg-gray-950">2</span>{" "}
              </a>
            </li>
            <li>
              <a href="" className="bg-gray-100 dark:bg-gray-950 text-xl px-10 py-3 rounded-xl">
                Technology <span className="ml-3 px-3 bg-gray-50 dark:bg-gray-950">1</span>{" "}
              </a>
            </li>
            <li>
              <a href="" className="bg-gray-100 dark:bg-gray-950 text-xl px-10 py-3 rounded-xl">
            ...
            <li>
              <a href="" className="bg-gray-100 dark:bg-gray-950 text-xl px-10 py-3 rounded-xl">
                Architecture <span className="ml-3 px-3 bg-gray-50 dark:bg-gray-950">1</span>{" "}
              </a>
            </li>
          </ul>
        </div>
