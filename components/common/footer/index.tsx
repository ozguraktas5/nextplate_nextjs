        ...
        <div className="flex gap-4">
          <a href="https://www.facebook.com/?locale=tr_TR">
            <svg
              ...
              height="40"
              fill="currentColor"
              className="bi bi-facebook bg-black text-white p-2 rounded-lg"
              viewBox="0 0 16 16"
            >
          ...
          <a href="https://x.com/?logout=1718008890570">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
              height="40"
              fill="currentColor"
              className="bi bi-twitter-x bg-black text-white p-2 rounded-lg"
              viewBox="0 0 16 16"
            >
          ...
          <a href="https://github.com/">
            <svg
              ...
              height="40"
              fill="currentColor"
              className="bi bi-github bg-black text-white p-2 rounded-lg"
              viewBox="0 0 16 16"
            >
          ...
          <a href="https://www.linkedin.com/home">
            <svg
              ...
              height="40"
              fill="currentColor"
              className="bi bi-linkedin bg-black text-white p-2 rounded-lg"
              viewBox="0 0 16 16"
            >
